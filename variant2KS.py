...
if __name__ == '__main__':
    ...
    conf_matrix, accuracy, precision_macro, recall_macro, f1_macro, precision_micro, recall_micro, f1_micro, test_loss, test_accuracy = test(model, device, test_loader)
