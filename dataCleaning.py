...
input_base_directory = 'dataset/dataoriginal/test'
output_base_directory = 'dataset/datacleaning/test'
...
for subdirectory in os.listdir(input_base_directory):
    # Get the complete directory path of subdirectory
    ...
    # To Ensure that output directory exists
    os.makedirs(output_directory, exist_ok=True)

    # Loop through the images in the input directory
    for filename in os.listdir(input_directory):
        # Get the complete directory path of images
        ...
        if image is not None:
            ...
            # Resizing the image to the new dimensions using high-quality interpolation to avoid pixel loss
